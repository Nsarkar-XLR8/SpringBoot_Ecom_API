-- Flyway baseline + hardening migration.
-- Designed to be idempotent for existing local databases.
...
-- 4) Legacy compatibility cleanup from old order-payment model
